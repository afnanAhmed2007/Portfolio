...
import imageToAddFour from './Quant.jpeg'; 
            ...
            <div className="flex flex-col items-center gap-20" style={{marginTop: "200px"}}>
                ...
                <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1, transition: { duration: 1, ease: "easeIn" } }}>
                    <motion.div whileHover={{ scale: 1.05 }} onHoverStart={() => console.log('hover started!')}>
                        <div className="bg-gray-100 gap-6" style={{width: "800px", padding: "28px 32px", height: "275px", boxShadow: "0 10px 12px rgba(0,0,0,0.08)", border: "1px solid #e5e7eb", borderRadius: 16,  background: "linear-gradient(#ffffff, #9ea4a1)"}} >
                            <h1 className="text-xl font-medium" style={{fontFamily: 'Inter',  height: "15px", display: "flex", justifyContent: "flex-start", alignItems: "center", color: "black"}}>Quantitative Developer</h1>
                            <h2 style={{fontFamily: 'Inter', height: "15px", marginTop: "10px", marginBottom: "20px", display: "flex", justifyContent: "flex-start", alignItems: "center", color: "black"}}>Rutgers Quanitative Finance Club </h2>
                            <div className="w-full flex items-center gap-5">
                                <div className="w-[15%]" style={{color: "black"}}>
                                    <Image src={imageToAddFour} alt="Profile"  height={200} style={{ borderRadius: 10 }}></Image>
                                </div>
                                <div className="w-[75%] flex mx-auto" style={{color: "black"}}>
                                    <ul className="font-light" style={{ lineHeight: "1.9", fontFamily: 'Inter' }}>
                                        <li>•   Incoming quant developer as a member of the Road To Quant Program</li>
                                        <li>•   Implementing research on past papers (neural networks, game theory on quant trading) on upcoming projects</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-gray-100 gap-6" style={{width: "800px", padding: "28px 32px", height: "275px", boxShadow: "0 10px 12px rgba(0,0,0,0.08)", border: "1px solid #e5e7eb", borderRadius: 16,  background: "linear-gradient(#ffffff, #65c2c9)"}} >
                                ...
                                <div className="w-full flex items-center gap-5">
                                    <div className="w-[15%] items-center" style={{color: "black"}}>
                                        <Image src={imageToAddThree} alt="Profile" width={300} height={300} style={{ borderRadius: 10 }}></Image>
                                    </div>
                                    <div className="w-[75%]  flex mx-auto" style={{color: "black"}}>
                                        <ul className="font-light" style={{ lineHeight: "1.9", fontFamily: 'Inter' }}> 
